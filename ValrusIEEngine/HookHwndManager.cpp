...
void LookUpTheMessage(PMSG, CHAR[16])
{
...
LRESULT WINAPI CallWndProc(int nCode, WPARAM wParam, LPARAM lParam)
{
	...
	{
	case HC_ACTION:
		hResult = StringCchPrintfA(szCWPBuf, 256 / sizeof(TCHAR),
		...
		hResult = StringCchLengthA(szCWPBuf, 256 / sizeof(TCHAR), &cch);
		if (FAILED(hResult))
		{
			// TODO: write error handler
		}
		TextOutA(hdc, 2, 15, szCWPBuf, cch);
		break;
...
LRESULT CALLBACK GetMsgProc(int nCode, WPARAM wParam, LPARAM lParam)
{
	...
	case HC_ACTION:
		...
		{
		case PM_REMOVE:
			hResult = StringCchCopyA(szRem, 16 / sizeof(TCHAR), "PM_REMOVE");
			if (FAILED(hResult))
			{
				// TODO: write error handler
			}
		...
		case PM_NOREMOVE:
			hResult = StringCchCopyA(szRem, 16 / sizeof(TCHAR), "PM_NOREMOVE");
			if (FAILED(hResult))
			{
				// TODO: write error handler
			}
		...
		default:
			hResult = StringCchCopyA(szRem, 16 / sizeof(TCHAR), "Unknown");
			if (FAILED(hResult))
			{
				// TODO: write error handler
			}
		...
		hdc = GetDC(gh_hwndMain);
		hResult = StringCchPrintfA(szMSGBuf, 256 / sizeof(TCHAR),
		...
		hResult = StringCchLengthA(szMSGBuf, 256 / sizeof(TCHAR), &cch);
		if (FAILED(hResult))
		{
			// TODO: write error handler
		}
		TextOutA(hdc, 2, 35, szMSGBuf, cch);
		break;
...
LRESULT CALLBACK CBTProc(int nCode, WPARAM wParam, LPARAM lParam)
{
	...
	{
	case HCBT_ACTIVATE:
		hResult = StringCchCopyA(szCode, 128 / sizeof(TCHAR), "HCBT_ACTIVATE");
		if (FAILED(hResult))
		{
			// TODO: write error handler
		}
	...
	case HCBT_CLICKSKIPPED:
		hResult = StringCchCopyA(szCode, 128 / sizeof(TCHAR), "HCBT_CLICKSKIPPED");
		if (FAILED(hResult))
		{
			// TODO: write error handler
		}
	...
	case HCBT_CREATEWND:
		hResult = StringCchCopyA(szCode, 128 / sizeof(TCHAR), "HCBT_CREATEWND");
		if (FAILED(hResult))
		{
			// TODO: write error handler
		}
	...
	case HCBT_DESTROYWND:
		hResult = StringCchCopyA(szCode, 128 / sizeof(TCHAR), "HCBT_DESTROYWND");
		if (FAILED(hResult))
		{
			// TODO: write error handler
		}
	...
	case HCBT_KEYSKIPPED:
		hResult = StringCchCopyA(szCode, 128 / sizeof(TCHAR), "HCBT_KEYSKIPPED");
		if (FAILED(hResult))
		{
			// TODO: write error handler
		}
	...
	case HCBT_MINMAX:
		hResult = StringCchCopyA(szCode, 128 / sizeof(TCHAR), "HCBT_MINMAX");
		if (FAILED(hResult))
		{
			// TODO: write error handler
		}
	...
	case HCBT_MOVESIZE:
		hResult = StringCchCopyA(szCode, 128 / sizeof(TCHAR), "HCBT_MOVESIZE");
		if (FAILED(hResult))
		{
			// TODO: write error handler
		}
	...
	case HCBT_QS:
		hResult = StringCchCopyA(szCode, 128 / sizeof(TCHAR), "HCBT_QS");
		if (FAILED(hResult))
		{
			// TODO: write error handler
		}
	...
	case HCBT_SETFOCUS:
		hResult = StringCchCopyA(szCode, 128 / sizeof(TCHAR), "HCBT_SETFOCUS");
		if (FAILED(hResult))
		{
			// TODO: write error handler
		}
	...
	case HCBT_SYSCOMMAND:
		hResult = StringCchCopyA(szCode, 128 / sizeof(TCHAR), "HCBT_SYSCOMMAND");
		if (FAILED(hResult))
		{
			// TODO: write error handler
		}
	...
	default:
		hResult = StringCchCopyA(szCode, 128 / sizeof(TCHAR), "Unknown");
		if (FAILED(hResult))
		{
			// TODO: write error handler
		}
	...
	hResult = StringCchPrintfA(szBuf, 128 / sizeof(TCHAR), "CBT -  nCode: %s, tsk: %ld, %d times   ",
		szCode, wParam, c++);
	if (FAILED(hResult))
	{
		// TODO: write error handler
...
LRESULT CALLBACK KeyboardProc(int nCode, WPARAM wParam, LPARAM lParam)
{
	...
	hdc = GetDC(gh_hwndMain);
	hResult = StringCchPrintfA(szBuf, 128 / sizeof(TCHAR), "KEYBOARD - nCode: %d, vk: %d, %d times ", nCode, wParam, c++);
	if (FAILED(hResult))
	{
		// TODO: write error handler
	}
...
HookHwndManager::HookHwndManager()
{
}
...
void HookHwndManager::SetHook(HWND wndToAttach)
{
	...
	//}
	DWORD threadId;
	GetWindowThreadProcessId(wndToAttach, &threadId);

	// get HINSTANCE of console, based on HWND
	HINSTANCE hInstance = (HINSTANCE)GetWindowLong(wndToAttach, GWL_HINSTANCE);
	...
	myhookdata[IDM_GETMESSAGE].hhook = SetWindowsHookEx(
		myhookdata[IDM_GETMESSAGE].nType,
		myhookdata[IDM_GETMESSAGE].hkprc,
		hInstance, threadId);
